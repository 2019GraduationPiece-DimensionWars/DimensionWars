...
XMFLOAT4 HeightMapGridMesh::OnGetColor(int x, int z, void * pContext)
{
	...
	float fScale = Vector3::DotProduct(pHeightMapImage->GetPointToHeightMapNormal(x, z), xmf3LightDirection);
	fScale += Vector3::DotProduct(pHeightMapImage->GetPointToHeightMapNormal(x + 1, z), xmf3LightDirection);
	fScale += Vector3::DotProduct(pHeightMapImage->GetPointToHeightMapNormal(x + 1, z + 1), xmf3LightDirection);
	fScale += Vector3::DotProduct(pHeightMapImage->GetPointToHeightMapNormal(x, z + 1), xmf3LightDirection);
...
void HeightMapGridMesh::OnPreRender(ID3D12GraphicsCommandList * pd3dCommandList, void * pContext)
{
...
void HeightMapGridMesh::Render(ID3D12GraphicsCommandList * pd3dCommandList, int nSubSet)
{
