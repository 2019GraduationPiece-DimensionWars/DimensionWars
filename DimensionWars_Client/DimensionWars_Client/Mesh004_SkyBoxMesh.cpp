...
SkyBoxMesh::SkyBoxMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : NoneHierarchyMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 36;
