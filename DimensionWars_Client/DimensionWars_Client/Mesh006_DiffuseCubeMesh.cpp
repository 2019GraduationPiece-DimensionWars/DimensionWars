...
TextureCubeMesh::~TextureCubeMesh()
{
}

//////////////////////////////////////////////////////////////////////////////////
//
TextureCubeMesh::TextureCubeMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : NoneHierarchyMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 36;
	...
	int i = 0;
	//36개 쓴이유는  인덱스로는 정확하게 표현할수 없기 때문 정점이 달라야하는데 8개의 정점으로는 표현 불가
	// 텍스처 좌표를 가진 육면체를 표현 
